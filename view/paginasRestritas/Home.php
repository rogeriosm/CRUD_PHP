    ...
    <div class="row">
        ...
        <nav class="col-2">
            ...
            <div class="fotoPerfil">
                ...
                <form method="post" action="/crud_php/controle/FotosPerfilControllerSalvar.php" enctype="multipart/form-data">
                    <label for="fotoPerfil" class="btn btn-outline-dark btn-sm">Foto Perfil <i
                                class="fas fa-camera"></i></label>
                    <input type="file" name="fotoPerfil" id="fotoPerfil" class="inputtypefile" onchange="previewImage()"><br>

                    <!--model-->
                    <div id="fundo"></div>
                    <div id="janela">
                        <span class="btn btn-outline-dark btn-lg" onclick="fecharModal();">cancelar</span>
                        <input type="submit" value="Alterar Foto" class="btn btn-success btn-lg">
                        <img id="preview" class="preview" src="" alt="imgPerfil">
                    </div>
            ...
            <a href="/crud_php/view/configuracoes/deslogar.php" class="link">
                <button type="button" class="btn btn-outline-dark btn-sm">Deslogar</button>
            </a><br>

            <a href="/crud_php/index.php">
                <button class="btn btn-outline-dark btn-sm" style="margin-top: 8px">Index</button>
            </a><br>

            <a href="/crud_php/view/paginasRestritas/Album.php">
                <button class="btn btn-outline-dark btn-sm"style="margin-top: 8px">Album</button>
            </a>
